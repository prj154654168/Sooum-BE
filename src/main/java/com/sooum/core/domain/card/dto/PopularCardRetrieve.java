...
public class PopularCardRetrieve extends CardDto {
    ...
    @Builder
    public PopularCardRetrieve(String id, boolean isStory, String content, LocalDateTime createdAt, int likeCnt, boolean isLiked, int commentCnt, boolean isCommentWritten, Link backgroundImgUrl, Font font, FontSize fontSize, Double distance) {
